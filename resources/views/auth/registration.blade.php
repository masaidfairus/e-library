                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="text" name="name" id="name" autocomplete="name" value="{{ old('name') }}" required
                            class="@error('name') border-red-500 focus:ring-red-500 focus:border-red-500
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="text" name="email" id="email" autocomplete="email" value="{{ old('email') }}"
                            required
                            class="@error('email') border-red-500 focus:ring-red-500 focus:border-red-500
                                            @enderror block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                        @error('email')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="text" name="username" id="username" autocomplete="username"
                            ...
                            class="@error('username') border-red-500 focus:ring-red-500 focus:border-red-500
                                                            @enderror block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                        @error('username')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
